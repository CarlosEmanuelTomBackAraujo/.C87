...
/*
    ...
    Então, use c para ajustar a cor para "grey".
...
ctx.lineWidth = 5;
ctx.arc(x=250, y=210, radius=40, startAngle=0, endAngle=2* Math.PI );
ctx.stroke();
...
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x=450, y=210, radius=40, startAngle=0, endAngle=2* Math.PI);
ctx.stroke();
